...
@section('content')
    <table class="table table-hover align-middle bg-white border text-sedondary">
                        ...
                        @if (Auth::user()->id !== $user->id)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    @if ($user->trashed())
                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-toggle="modal" data-bs-target="#activate-user-{{ $user->id }}">
